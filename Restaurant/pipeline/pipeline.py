...
import os,sys
from Restaurant.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact, ModelPusherArtifact,\
...
from Restaurant.component.model_pusher import ModelPusher
