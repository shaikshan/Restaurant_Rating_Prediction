...
from Restaurant.entity.artifact_entity import ModelEvaluationArtifact,ModelPusherArtifact
import os,sys
...
class ModelPusher:
    ...
    def export_model(self)->ModelPusherArtifact:
        try:
            ...
            logging.info(f"Exporting model file name:[{export_model_file_path}]")
    ...
    def initiate_model_pusher(self)->ModelPusherArtifact:
        try:
            ...
            raise RestaurantException(e,sys) from e
    def __del__(self):
        logging.info(f"{'>>'*30}--ModelPusherEnded--{'<<'*30}")